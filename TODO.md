...
## ✅ 일일 챌린지 + PWA (v3.5 사이클 10 - 2026-02-07)

### 일일 챌린지
- [x] **날짜 기반 결정적 퍼즐 생성** — Mulberry32 PRNG, 같은 날이면 같은 10×10 퍼즐
- [x] **유일한 해 검증** — Line solving으로 풀 수 있는 퍼즐만 출제
- [x] **채움률 35-50%** — 적절한 난이도
- [x] **오늘의 퍼즐 카드** — 홈 화면 상단 배치, 탭하여 시작
- [x] **진행 상태 표시** — 진행률 바, 완료 시 ✅ 뱃지
- [x] **연속 플레이 일수 (streak)** — 🔥 N일 연속
- [x] **캘린더 뷰 (최근 7일)** — 완료/미완료 표시
- [x] **게임 자동 저장** — 일일 퍼즐 진행 중 이탈 시 복원
- [x] **GameScreen isDaily 모드** — 오늘의 퍼즐 타이틀, 완료 시 홈으로

### PWA 지원
- [x] **manifest.json** — standalone 모드, 아이콘
- [x] **서비스 워커** — cache-first + stale-while-revalidate 전략
